...
const developers_schema_1 = require("./schemas/developers.schema");
let DevelopersService = exports.DevelopersService = class DevelopersService {
...
exports.DevelopersService = DevelopersService = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(developers_schema_1.DeveloperModel.name)),
